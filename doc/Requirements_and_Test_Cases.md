...
| ID | Pri | Requirement | Verify |
| --- | --- | --- | --- |
| REQ-MEM-01 | M | Framebuffers shall reside in SDRAM at `0xD0000000` and shall not exceed the mapped 8 MB window of the 16 MB part. | INSP, IT |
...
**TC-MEM-01 (IT) — SDRAM**  
Walking 1s / 0s over the mapped 8 MB window of the 16 MB SDRAM; fail on mismatch.
